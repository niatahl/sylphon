...
public class SRD_CondemnationOscillationScript implements EveryFrameWeaponEffectPlugin {
    ...
    private SRD_CondemnationMuzzleFlashScript muzzleFlashScript = null;
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (muzzleFlashScript == null) {
            muzzleFlashScript = new SRD_CondemnationMuzzleFlashScript();
        }
