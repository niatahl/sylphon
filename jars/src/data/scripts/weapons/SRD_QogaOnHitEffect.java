...
public class SRD_QogaOnHitEffect implements OnHitEffectPlugin {
    ...
    private static final Color EXPLOSION_COLOR = new Color(255f/255f, 35f/255f, 0f/255f, 130f/255f);
    private static final float EXPLOSION_SIZE = 90f;
    private static final float EXPLOSION_DURATION_MIN = 0.3f;
    private static final float EXPLOSION_DURATION_MAX = 0.6f;

    //Variables for the small particles generated with the explosion
    private static final int PARTICLE_COUNT = 4;
    private static final Color PARTICLE_COLOR = new Color(255f/255f, 35f/255f, 0f/255f, 130f/255f);
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, CombatEngineAPI engine) {
        ...
        Global.getCombatEngine().applyDamage(target, point, projectile.getDamageAmount()*DAMAGE_MULT, DamageType.HIGH_EXPLOSIVE, 0, true, false, null, true);
