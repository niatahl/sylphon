...
public class SRD_EnochianMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(0f, 38f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(0f, 46.5f));
    }
    ...
    //Instantiator
    public SRD_EnochianMuzzleFlashScript() {}
