...
public class SRD_CondemnationMuzzleFlashScript {
    ...
    */
    ...
    static {
        USED_IDS.add("SMOKE_ID_1");
        USED_IDS.add("SMOKE_ID_2");
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(5.5f, 0.5f));
        PARTICLE_SPAWN_POINT_TURRET.put("SMOKE_ID_2", new Vector2f(-5.5f, 0.5f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(5.5f, 2.5f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("SMOKE_ID_2", new Vector2f(-5.5f, 2.5f));
    }
    ...
    static {
        PARTICLE_COLOR.put("default", new Color(190, 190, 190, 40));
    }
    ...
    static {
        PARTICLE_SIZE_MAX.put("default", 11f);
    }
