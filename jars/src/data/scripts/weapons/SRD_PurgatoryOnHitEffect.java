...
public class SRD_PurgatoryOnHitEffect implements OnHitEffectPlugin {

    private static final Color COLOR1 = new Color(70,150,255);
    private static final Color COLOR2 = new Color(235, 235, 255);
