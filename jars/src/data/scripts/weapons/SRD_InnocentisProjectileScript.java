...
public class SRD_InnocentisProjectileScript extends BaseEveryFrameCombatPlugin {
	...
	private static final String GUIDANCE_MODE_SECONDARY = "DUMBCHASER_SWARM";
	...
	private static final float TARGET_REACQUIRE_RANGE = 1000;
	...
	private static final float TARGET_REACQUIRE_ANGLE = 180;
	 ...
	 */
	public SRD_InnocentisProjectileScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
